...
| Literal / pattern terminal | `'text'`, `/regex/` | [Terminals](docs/tutorial/02-syntax.md#terminals-literals-and-patterns) |
...
| Directives | `%axiom`, `%conflicts`, `%inline`, `%supertypes`, `%extras`, `%include` | [Directives](docs/tutorial/03-directives.md) |
