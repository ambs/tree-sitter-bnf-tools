...
| `scaffold` | Scaffold a complete Rust library crate (parser + ANTLR-style Visitor trait + optional typed AST structs + runnable example) | [Generating a processing scaffold](docs/tutorial/11-generating-a-scaffold.md) |
