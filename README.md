...
| `scaffold` | Scaffold a complete Rust library crate (parser + ANTLR-style Visitor trait + runnable example) | [Generating a processing scaffold](docs/tutorial/11-generating-a-scaffold.md) |
