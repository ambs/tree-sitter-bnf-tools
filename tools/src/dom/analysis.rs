...
///
/// let g = Grammar::from_rules([
///     Production { name: "word".into(), body: GrammarNode::TerminalPattern("/[a-z]+/".into()), line: 0, filename: String::new() },
///     Production { name: "kw".into(),   body: GrammarNode::TerminalLiteral("'if'".into()), line: 0, filename: String::new() },
/// ]);
/// let f = first_sets(&g);
...
/// // digit -> /[0-9]/ ;  num -> digit ;
/// let g = Grammar::from_rules([
///     Production { name: "digit".into(), body: GrammarNode::TerminalPattern("/[0-9]/".into()), line: 0, filename: String::new() },
///     Production { name: "num".into(),   body: GrammarNode::NonTerminal("digit".into()), line: 0, filename: String::new() },
/// ]);
/// let f = first_sets(&g);
